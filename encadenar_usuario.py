#EJERCICIO USUARIO PERO CON METODOS ENCADENADOS
...
usuario_uno.hacer_deposito(20).hacer_deposito(35).hacer_deposito(15).hacer_retiro(100).mostrar_balance_usuario()

#Que el segundo usuario haga 2 depósitos y 2 giros y luego muestre sus balances:
usuario_dos.hacer_deposito(40).hacer_deposito(65).hacer_retiro(70).hacer_retiro(28).mostrar_balance_usuario()

#Que el tercer usuario haga 1 depósito y 3 giros y luego muestre sus balances:
usuario_tres.hacer_deposito(36).hacer_retiro(50).hacer_retiro(6).hacer_retiro(10).mostrar_balance_usuario()

#Que el primer usuario haga transferencia al tercer usuario y luego muestren sus balances
usuario_uno.transfer_dinero(usuario_tres,90).mostrar_balance_usuario()
